...
Este documento apresenta a especificação técnica completa e atualizada do Data Warehouse (DW) para a **AlfaMaq Manufatura S.A.**, estruturado no modelo dimensional (Star Schema / Bus Architecture).
...
*   **Local_Armazenamento_Destino** (VARCHAR(150)): Armazém onde são estocados os itens produzidos nesta máquina.
